...
""""""""""""""""""""""""
syntax keyword javaScriptBrowserObjects           window navigator screen history location document

syntax keyword javaScriptDOMObjects               event HTMLElement Anchor Area Base Body Button Form Frame Frameset Image Link Meta Option Select Style Table TableCell TableRow Textarea
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  " Ajax Highlighting
	HiLink javaScriptBrowserObjects     Keyword
